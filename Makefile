srcdir = /tmp/iptocity
builddir = /tmp/iptocity
top_srcdir = /tmp/iptocity
top_builddir = /tmp/iptocity
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php54/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php54/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = re2c
AWK = gawk
shared_objects_iptocity = iptocity.lo
PHP_PECL_EXTENSION = iptocity
PHP_MODULES = $(phplibdir)/iptocity.la
PHP_ZEND_EX =
...
prefix = /usr/local/php54
phplibdir = /tmp/iptocity/modules
phpincludedir = /usr/local/php54/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
PHP_EXECUTABLE = /usr/local/php54/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php54/include/php -I/usr/local/php54/include/php/main -I/usr/local/php54/include/php/TSRM -I/usr/local/php54/include/php/Zend -I/usr/local/php54/include/php/ext -I/usr/local/php54/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
